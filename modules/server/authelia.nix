{
  ...
  nginxAuthLocation = {
    locations."/internal/authelia/authz/basic" = {
      proxyPass = "http://localhost:${cfg.port}/api/authz/auth-request/basic";
  ...
  options.hellebore.server.authelia =
    {
      ...
      nginx = {
        authLocationConfig = mkOption {
          type = types.attrs;
          default = nginxAuthLocation;
          readOnly = true;
        ...
        authRequestConfig = mkOption {
          type = types.attrs;
          default = nginxAuthRequestConfig;
          readOnly = true;
